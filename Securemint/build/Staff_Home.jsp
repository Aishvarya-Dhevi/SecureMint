            ...
            <div class="branding d-flex align-items-center">
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>             
                             <li><a href="Staff_Home.jsp" class="active"> Home</a></li>    
        ...
        <main class="main">
            ...
            <section id="about" class="about section">
                ...
                <div class="container section-title" data-aos="fade-up">
                    ...
                    <h2>About Us<br></h2>
                    <p>Our platform ensures Secure and Transparent Exams with Seamless Assessments, and an Enhanced Exam Experience.</p>
                ...
                <div class="container">
                    ...
                    <div class="row gy-4">
                        ...
                        <div class="col-lg-6 order-2 order-lg-2 content" data-aos="fade-up" data-aos-delay="200">
                            <h3>Experience Trust and Security ?Blockchain-Powered Exams!</h3>

                            <ul>
                                <li><i class="bi bi-check-circle"></i> <span>Secure and Transparent Exam Management with Blockchain-Powered Integrity.</span></li>
                                <li><i class="bi bi-check-circle"></i> <span>Seamless Exam Conduct with Tamper-Proof Records and Secure Data Storage.</span></li>
                                <li><i class="bi bi-check-circle"></i> <span>Efficient and Reliable Assessments with Automated Verification for Maximum Accuracy.</span></li>
                            </ul>
