...
.exam-container a:hover {
    ...
    <body class="index-page">
            ...
            <div class="branding d-flex align-items-center">
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    <a href="index.jsp" class="logo d-flex align-items-center">
                        ...
                        <h1 class="sitename">EXAM GUARD</h1>
                    </a>
       ...
       <h2 class="header-title">Your Exams</h2>

<%
    ResultSet ts = db.Select("SELECT * FROM create_exam WHERE Staff_Id='" + id + "'");
    while(ts.next()){
...
%>
    <div class="exam-container">
        ...
        <a href="Add_Question.jsp?CE_Id=<%=CE_Id%>">Add Questions</a>
    </div>
<% } %>
                ...
                <div class="row gy-4">
                    <div class="col-lg-4 col-md-6">
                        <div class="footer-about">
                            <a href="index.html" class="logo sitename">EXAM GUARD</a>
