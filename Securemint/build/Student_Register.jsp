...
<link href="css/form.css" rel="stylesheet">
                ...
                <div class="container position-relative d-flex align-items-center justify-content-between">
                    ...
                    <nav id="navmenu" class="navmenu">
                        <ul>
                            ...
                            <li><a href="Student_Register.jsp" class="active">Student Register</a></li>                            
 ...
 <h2 class="header-title">Student Register</h2>
                    ...
                    <form action="Student_Register" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="formbold-mb-3">
                         ...
                         <div class="formbold-mb-3">
                            <div>
                                ...
                                <input type="text" id="name" name="College_Name" placeholder="Enter College name" class="formbold-form-input" required>
                            </div>
                        </div>
                        
                        <div class="formbold-mb-3">
                            <div>
                                <label for="name" class="formbold-form-label">Register Number:</label>
                                <input type="text" id="name" name="Register_Number" placeholder="Enter Register Number" class="formbold-form-input" required>
                            </div>
                        </div>
                        ...
                        <div class="formbold-mb-3">
                            <div>
                                ...
                                <input type="text" id="name" name="Department" placeholder="Enter Department name" class="formbold-form-input" required>
                            </div>
                        </div>
                        ...
                        <div class="formbold-mb-3">
                            <div>
                                ...
                                <input type="text" id="name" name="Year" placeholder="Enter Year" class="formbold-form-input" required>
                            </div>
                        </div>
